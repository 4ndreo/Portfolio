...
// },
{
  ...
  data: [
    ...
    { name: 'Vue', type: 'frontend', icon: 'VueIcon' },
    { name: 'Angular', type: 'frontend', icon: 'AngularIcon' },
    { name: 'Astro', type: 'frontend', icon: 'AstroIcon' },
    { name: 'Ionic', type: 'hibrid', icon: 'IonicIcon' },
    { name: 'Nest', type: 'backend', icon: 'NestIcon' },
    { name: 'Laravel', type: 'backend', icon: 'LaravelIcon' },
    { name: 'PHP', type: 'backend', icon: 'PHPIcon' },
    { name: 'Express', type: 'backend', icon: 'ExpressIcon' },
    { name: 'Tailwind', type: 'css', icon: 'TailwindIcon' },
    { name: 'Bootstrap', type: 'css', icon: 'BootstrapIcon' },
    { name: 'SQLServer', type: 'database', icon: 'SQLServerIcon' },
    { name: 'MySQL', type: 'database', icon: 'MySQLIcon' },
